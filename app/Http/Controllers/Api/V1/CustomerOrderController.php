...
class CustomerOrderController extends Controller
{
  ...
  /**
   * Hiển thị chi tiết một đơn hàng của khách hàng đã đăng nhập
   *
   * @param Order $order
   * @return JsonResponse
   */
  ...
  /**
   * Tạo đơn hàng mới từ giỏ hàng của khách hàng đã đăng nhập
   *
  ...
  /**
   * Hủy đơn hàng của khách hàng đã đăng nhập
   *
   * @param Order $order
   * @return JsonResponse
   */
