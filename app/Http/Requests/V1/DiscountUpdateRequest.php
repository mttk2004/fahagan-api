...
class DiscountUpdateRequest extends BaseRequest implements HasValidationMessages
{
    public function rules(): array
    {
        return [
            ...
            'data.attributes.discount_value' => ['sometimes', 'decimal:0,1', 'min:0.0'],
            'data.attributes.min_purchase_amount' => ['sometimes', 'decimal:0,1', 'min:0.0'],
            'data.attributes.max_discount_amount' => ['sometimes', 'decimal:0,1', 'min:0.0'],
