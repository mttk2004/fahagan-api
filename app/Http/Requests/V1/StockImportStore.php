...
class StockImportStoreRequest extends BaseRequest implements HasValidationMessages
{
  public function rules(): array
  {
    return [
      ...
      'data.relationships.employee.id' => [
        'required',
        'exists:users,id',
      ],
  ...
  public function messages(): array
  {
    return [
      ...
      'data.relationships.employee.id.required' => 'Nhân viên là trường bắt buộc.',
      'data.relationships.employee.id.exists' => 'Nhân viên không tồn tại.',
      'data.relationships.items.required' => 'Danh sách sách là trường bắt buộc.',
      'data.relationships.items.array' => 'Danh sách sách nên là một mảng.',
