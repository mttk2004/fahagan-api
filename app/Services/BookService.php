...
class BookService extends BaseService
{
     ...
     */
    public function getAllBooks(Request $request, int $perPage = ApplicationConstants::PER_PAGE, $trashed = false): LengthAwarePaginator
    {
        return $this->getAll($request, $perPage, $trashed);
    }
     ...
     * @throws Throwable
     */
    public function restoreBook(string|int $bookId): Book
    {
        return $this->restore($bookId);
    }
