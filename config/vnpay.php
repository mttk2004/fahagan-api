...
return [
  ...
  'clientSuccessUrl' => env('VNP_CLIENT_SUCCESS_URL', 'http://localhost:3000/payment/success'),
  'clientFailedUrl' => env('VNP_CLIENT_FAILED_URL', 'http://localhost:3000/payment/failed'),
  'version' => '2.1.0',
  'command' => 'pay',
  'currCode' => 'VND',
  'locale' => 'vn',
