...
class VNPayPaymentTest extends TestCase
{
    ...
    public function it_can_handle_vnpay_return()
    {
        ...
        $response = $this->getJson("/api/v1/payments/vnpay-return?vnp_Amount=20000000&vnp_ResponseCode=00");
    ...
    public function it_handles_invalid_signature_from_vnpay()
    {
        ...
        $response = $this->getJson("/api/v1/payments/vnpay-return?invalid=true");
    ...
    public function it_handles_failed_payment()
    {
        ...
        $response = $this->getJson("/api/v1/payments/vnpay-return?vnp_Amount=20000000&vnp_ResponseCode=24");
