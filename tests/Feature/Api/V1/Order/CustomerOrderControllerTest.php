...
class CustomerOrderControllerTest extends TestCase
{
    ...
    #[Test]
    public function customer_cannot_create_order_with_invalid_phone_format()
    {
        Sanctum::actingAs($this->customer);
        ...
        $response = $this->postJson('/api/v1/customer/orders', [
          'data' => [
            'attributes' => [
              'method' => 'cash',
              'shopping_name' => 'Test Customer',
              'shopping_phone' => '123456', // Số điện thoại không hợp lệ
              'shopping_city' => 'HCM',
              'shopping_district' => '1',
              'shopping_ward' => '1',
              'shopping_address_line' => '123 Test Street',
        ...
        $response->assertStatus(422)
          ->assertJsonValidationErrors(['data.attributes.shopping_phone']);
    }
}
