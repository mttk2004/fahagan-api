...
class OrderServiceTest extends TestCase
{
    ...
    public function it_does_not_update_book_quantities_for_other_status_changes()
    {
        ...
        // Cập nhật trạng thái đơn hàng từ APPROVED sang DELIVERED
        $updatedOrder = $this->orderService->updateOrderStatus($this->order->id, OrderStatus::DELIVERED->value);
        ...
        $this->assertEquals(OrderStatus::DELIVERED->value, $updatedOrder->status);
